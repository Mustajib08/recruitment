...
@section('content_home')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="{{ asset('assets_home') }}/img/service/support-img.jpg" alt="">
    ...
    <div class="apply-process-area apply-bg mt-150 pt-150 pb-150"
                            ...
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder  ">
                                    <div class="founder-img mb-30">
                                        <img src="{{ asset('assets_home') }}/img/testmonial/testimonial-founder.png"
                                            alt="">
    ...
    <div class="online-cv cv-bg section-overly pt-90 pb-120"
        data-background="{{ asset('assets_home') }}/img/gallery/cv_bg.jpg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{ asset('assets_home') }}/img/blog/home-blog1.jpg" alt="">
                                <!-- Blog date -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{ asset('assets_home') }}/img/blog/home-blog2.jpg" alt="">
                                <!-- Blog date -->
                                <div class="blog-date text-center">
                                    <span>24</span>
                                    <p>Now</p>
